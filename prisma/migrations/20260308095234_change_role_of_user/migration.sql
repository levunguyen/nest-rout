...
-- AlterEnum
BEGIN;
CREATE TYPE "public"."UserRole_new" AS ENUM ('ADMIN_GENEALOGY', 'EDITOR_GENEALOGY', 'VIEWER_GENEALOGY');
...
ALTER TABLE "public"."User" ALTER COLUMN "role" SET DEFAULT 'ADMIN_GENEALOGY';
COMMIT;
